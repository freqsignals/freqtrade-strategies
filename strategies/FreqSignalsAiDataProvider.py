...
# EXAMPLE_DIFFERENCE - inherited from FreqSignalsMixin
...
# class FreqSignalsAiDataProvider(IStrategy):
    ...
    # EXAMPLE_DIFFERENCE - added this __init__
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # EXAMPLE_DIFFERENCE - added this __init__
        # Begin uploading signal to FreqSignals. Above here is from the FreqaiExampleStrategy
        ...
        # See if we've uploaded a signal for this candle yet
        if (last_update_time is None or last_update_time != current_candle_time):
            ...
            # Use one of the AI-generated indicators for the value
            ...
            signal_data = {
                ...
                # Additional context for the AI-generated context
